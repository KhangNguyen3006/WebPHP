...
<table class="table">
  ...
  foreach ($products as $p) { 
    ...
    <tr>
      ...
      <td><a href='<?php echo BASE_URL ?>adminproduct/productDelete/<?php echo $p['productId'] ?>'onclick='return confirm("Bạn có chắc chắn xóa vĩnh viễn sản phẩm này?") ;'>Xóa vĩnh viễn</a>|
      <a href='<?php echo BASE_URL ?>adminproduct/productToggleTrash/<?php echo $p['productId'] ?>'> Khôi phục </a> </td>
    </tr>
     <?php } ?>
  </tbody>
</table>
