...
<table class="table">
  ...
  foreach ($cats as $p) { 
    ...
    <tr>
      ...
      <td><a href='<?php echo BASE_URL ?>admincategory/catDelete/<?php echo $p['catId'] ?>'onclick='return confirm("Bạn có chắc chắn xóa vĩnh viễn sản phẩm này?") ;'>Xóa vĩnh viễn</a>|
      <a href='<?php echo BASE_URL ?>admincategory/catToggleTrash/<?php echo $p['catId'] ?>'> Khôi phục </a> </td>
    </tr>
     <?php } ?>
  </tbody>
</table>
